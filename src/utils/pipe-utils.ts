...
export function asStringOrEmpty(
...
export function asFilledString(
  str: string | null | undefined,
  errMsg?: string,
): string {
...
export function asNullableStringOrDateTime(
...
export function asStringOrDateTime(
  str: string | Date,
  date?: Date | null | undefined,
  inputFormat?: string,
  fieldName?: string,
 ...
 */
export function asStringOrNumber(
...
export function asNullableStringOrNumber(
  val: string | number | null | undefined,
  fieldName?: string,
): number | null {
  const field = fieldName || 'StringOrNumber';
...
export function asNullableStringNumber(
  str: string | null | undefined,
  fieldName?: string,
  allowNaN = false,
): number | null {
...
export function asStringNumber(
  str: string | null | undefined,
  fieldName?: string,
  allowNaN = false,
): number {
...
export function asStringBoolean(
  str: string | null | undefined,
  fieldName?: string,
): boolean {
