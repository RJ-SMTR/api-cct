...
export const cnab240_104DetalheATemplateTest: CnabDetalheA_104 = {
  ...
  loteServico: { pos: [4, 7], picture: '9(004)', value: '0001', format: Cnab.format.number() },
  codigoRegistro: {
    pos: [8, 8],
    picture: '9(001)',
  ...
  nsr: { pos: [9, 13], picture: '9(005)', value: '00001', format: Cnab.format.number() },
  codigoSegmento: {
    pos: [14, 14],
    picture: 'X(001)',
  ...
  numeroDocumentoEmpresa: { pos: [74, 79], picture: '9(006)', value: '000027', format: Cnab.format.number() },
  ...
  quantidadeParcelas: { pos: [147, 148], picture: '9(002)', value: '01', format: Cnab.format.number() },
  ...
  numeroParcela: { pos: [153, 154], picture: '9(002)', value: '00', format: Cnab.format.number() },
  dataEfetivacao: { pos: [155, 162], picture: '9(008)', value: '00000000', format: Cnab.format.dateFormat() },
  valorRealEfetivado: {
    pos: [163, 177],
    picture: '9(013)V99',
    value: '000000000000000',
