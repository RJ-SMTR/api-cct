...
export const cnabDetalheE104V089Template: CnabDetalheE_104V089 = {
  ...
  complementoLancamento: { pos: [114, 133], picture: 'X(020)', value: ' '.repeat(20) },
  isencaoCpmf: { pos: [134, 134], picture: 'X(001)', value: ' ' },
  dataContabil: { pos: [135, 142], picture: '9(008)', value: '00000000', format: CnabConst.format.dateFormat() },
  dataLancamento: { pos: [143, 150], picture: '9(008)', value: '00000000', format: CnabConst.format.dateFormat() },
