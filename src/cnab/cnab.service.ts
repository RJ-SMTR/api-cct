        ...
        if (ordem.consorcio == 'STPC' || ordem.consorcio == 'STPL') {
          if (
            (favorecido.nome == 'ROSEVAL PEREIRA DE SOUZA' &&
              ordem.dataOrdem >= '2024-06-06' &&
              ordem.dataOrdem <= '2024-06-19') ||
            (favorecido.nome == 'JOAO SALES DE ALBUQUERQUE' &&
              ordem.dataOrdem >= '2024-06-06' &&
              ordem.dataOrdem <= '2024-06-26') ||
            (favorecido.nome == 'JOSE DIAS XIMENES' &&
              ordem.dataOrdem >= '2024-06-06' &&
              ordem.dataOrdem <= '2024-06-26') ||
            (favorecido.nome == 'EDUARDO CARLOS DE OLIVEIRA' &&
              ordem.dataOrdem >= '2024-06-20' &&
              ordem.dataOrdem <= '2024-07-03') ||
            (favorecido.nome == 'LUCIANO CALIXTO MARQUES' &&
              ordem.dataOrdem >= '2024-06-20' &&
              ordem.dataOrdem <= '2024-06-26') ||
            (favorecido.nome == 'AGUINALDO PAIVA RIBEIRO' &&
              ordem.dataOrdem >= '2024-06-27' &&
              ordem.dataOrdem <= '2024-07-03') ||
      ...
      const transacoes = transacoesView.filter(
        (transacaoView) =>
          ...
          isSameDay(
            ...
            subDays(publicacao.itemTransacao.dataOrdem, 1),
          ),
      );
