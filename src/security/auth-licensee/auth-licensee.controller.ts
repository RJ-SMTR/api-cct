...
import { MailHistoryApiParams } from 'src/domain/api-param/mail-history.api-param';
import { MailHistoryValidationPipe } from 'src/domain/pipes/mail-history-validation.pipe';
