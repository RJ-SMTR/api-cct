...
import { HeaderArquivoService } from "src/service/header-arquivo.service";
import { HeaderLoteService } from "src/service/header-lote.service";
import { DetalheAService } from "src/service/detalhe-a.service";
import { DetalheBService } from "src/service/detalhe-b.service";
import { OrdemPagamentoAgrupadoToHeaderArquivo } from "../domain/convertTo/ordem-pagamento-agrupado-to-header-arquivo.convert";
...
import { HeaderLoteToDetalheA } from "../domain/convertTo/header-lote-to-detalhe-a.convert";
import { DetalheAToDetalheB } from "../domain/convertTo/detalhe-a-to-detalhe-b.convert";
import { ICnabInfo } from "src/configuration/cnab/cnab.service";
import { SftpService } from "src/configuration/sftp/sftp.service";
...
import { DetalhesToCnab } from "../domain/convertTo/detalhes-to-cnab.convert";
...
import { CnabFile104PgtoDTO } from "src/configuration/cnab/interfaces/cnab-240/104/pagamento/cnab-file-104-pgto.interface";
import { CnabHeaderLote104PgtoDTO } from "src/configuration/cnab/interfaces/cnab-240/104/pagamento/cnab-header-lote-104-pgto.interface";
import { stringifyCnab104File } from "src/configuration/cnab/utils/cnab/cnab-104-utils";
import { CnabHeaderArquivo104DTO } from "src/configuration/cnab/dto/cnab-240/104/cnab-header-arquivo-104.dto";
