...
import { Cnab104AmbienteCliente } from 'src/configuration/cnab/enums/104/cnab-104-ambiente-cliente.enum';
import { DeepPartial } from 'typeorm';
import { HeaderArquivoTipoArquivo } from 'src/domain/enum/header-arquivo-tipo-arquivo.enum';
...
import { HeaderArquivoStatus } from 'src/domain/enum/header-arquivo-status.enum';
...
export class HeaderArquivoDTO {
  ...
  static fromEntity(entity: HeaderArquivo, isConf: boolean) {
