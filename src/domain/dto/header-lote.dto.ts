...
import { Cnab104CodigoCompromisso } from 'src/configuration/cnab/enums/104/cnab-104-codigo-compromisso.enum';
import { Cnab104FormaLancamento } from 'src/configuration/cnab/enums/104/cnab-104-forma-lancamento.enum';
import { CnabRegistros104Pgto, CnabRegistros104PgtoDTO } from 'src/configuration/cnab/interfaces/cnab-240/104/pagamento/cnab-registros-104-pgto.interface';
...
export class HeaderLoteDTO {
  ...
  static fromEntity(headerLote: HeaderLote, detalhes: IHeaderLoteDetalhes[], isTeste?: boolean): HeaderLoteDTO {
    return new HeaderLoteDTO({
  ...
  static fromEntities(headerLotes: (HeaderLote)[], detalheAs: (DetalheA)[], detalheBs: (DetalheB)[], itemTransacoes: ItemTransacao[], isTeste?: boolean): HeaderLoteDTO[] {
