...
import { TransacaoView, ITransacaoView } from 'src/domain/entity/transacao-view.entity';
import { IPreviousDaysArgs } from 'src/domain/interface/previous-days-args.interface';
