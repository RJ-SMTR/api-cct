...
import { BigqueryTransacao } from 'src/client/bigquery/entities/transacao.bigquery-entity';
...
import { SftpBackupFolder } from 'src/configuration/sftp/enums/sftp-backup-folder.enum';
import { SftpService } from 'src/configuration/sftp/sftp.service';
import { IClearSyncOrdemPgto, ISyncOrdemPgto } from 'src/domain/interface/sync-transacao-ordem.interface';
...
import { OrdemPagamentoDto } from '../../domain/dto/ordem-pagamento.dto';
...
import { TransacaoStatus } from '../../domain/entity/transacao-status.entity';
...
import { HeaderArquivoStatus } from '../../domain/enum/header-arquivo-status.enum';
import { PagadorContaEnum } from '../../domain/enum/pagador.enum';
import { TransacaoStatusEnum } from '../../domain/enum/transacao-status.enum';
