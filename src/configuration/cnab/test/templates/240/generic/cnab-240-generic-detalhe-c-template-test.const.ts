...
import { CnabFields } from 'src/configuration/cnab/interfaces/cnab-all/cnab-field.interface';

export const cnab240GenericDetalheCTemplateTest: CnabFields = {
  ...
  codigoSegmento: { pos: [12, 12], picture: 'X(001)', value: 'C', ...Cnab.insert.d() },
