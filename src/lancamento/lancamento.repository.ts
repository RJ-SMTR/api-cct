...
export class LancamentoRepository {
  ...
  save(entity: LancamentoEntity, options?: SaveOptions): Promise<LancamentoEntity> {
    return this.lancamentoRepository.save(entity, options);
  }

  findOne(options: FindOneOptions<LancamentoEntity>): Promise<LancamentoEntity | null>{
    return this.findOne(options);
  }

  findMany(options?: FindManyOptions<LancamentoEntity> | undefined): Promise<LancamentoEntity[]>{
