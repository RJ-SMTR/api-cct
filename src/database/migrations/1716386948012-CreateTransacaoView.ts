...
export class CreateTransacaoView1716386948012 implements MigrationInterface {
    name = 'CreateTransacaoView1716386948012'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "transacao_view" ADD CONSTRAINT "FK_TransacaoView_arquivoPublicacao_ManyToOne" FOREIGN KEY ("arquivoPublicacaoId") REFERENCES "arquivo_publicacao"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
