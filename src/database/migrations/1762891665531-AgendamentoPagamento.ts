...
export class AgendamentoPagamento1762891665531 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {   
        ...
        await queryRunner.query(`CREATE TABLE "agendamento_pagamento" ("id" integer NOT NULL, "tipoBeneficiario" character varying(200), "tipoPagamento" character varying(200), "dataPagamentoUnico" date NOT NULL, "valorPagamentoUnico" numeric(13,5) NOT NULL, "motivoPagamentoUnico" character varying, "diaSemana" character varying, "horario" TIME NOT NULL, "aprovacao" boolean, "status" boolean, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "beneficiarioUsuarioId" integer, "pagadorId" integer, "responsavelId" integer, "aprovacaoPagamentoId" integer, "cadastradorId" integer, "modificadorId" integer, CONSTRAINT "PK_AgendamentoPagamentoId" PRIMARY KEY ("id"))`);
