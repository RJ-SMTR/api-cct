...
export class FavorecidoNoUserFK1711646037126 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "setting" ADD CONSTRAINT "UQ_91a4f31e402dfa1da9b200ef924" UNIQUE ("name", "version")`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "setting" DROP CONSTRAINT "UQ_91a4f31e402dfa1da9b200ef924"`);
