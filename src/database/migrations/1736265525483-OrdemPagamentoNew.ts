...
export class OrdemPagamentoNew1736265525483 implements MigrationInterface {
    name = 'OrdemPagamentoNew1736265525483'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "detalhe_a" ADD "ordemPagamentoAgrupadoHistoricoId" integer NOT NULL`);
